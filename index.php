<?php include('include/header.php') ?>
    ...
    <!-- OUR Services -->
     <?php include('include/ourservice.php') ?>
    <!-- OUR Services -->
                    ...
                    <div class="row">
                        <div class="col-md-12 whychooeIconBox">
                            <div class="whychooeIconBoxInner">
                                <div class="iconChoose">
                                    <lottie-player
                                            src="assets/images/animations/Proven-Record.json"
                            ...
                            <div class="whychooeIconBoxInner">
                                <div class="iconChoose">
                                    <lottie-player
                                            src="assets/images/animations/Exclusive-E-Book-Writing-Services.json"
                                            background="transparent.html" speed="1" loop="" autoplay=""></lottie-player>
                                </div>
                                <div class="contentChoose">
                        ...
                        <div class="col-md-12 whychooeIconBox">
                            <div class="whychooeIconBoxInner">
                                <div class="iconChoose">
                                    <lottie-player
                                            src="assets/images/animations/Ongoing-Support.json"
                                            background="transparent.html" speed="1" loop="" autoplay=""></lottie-player>
                                </div>
                                <div class="contentChoose">
                            ...
                            <div class="whychooeIconBoxInner">
                                <div class="iconChoose">
                                    <lottie-player
                                            src="assets/images/animations/Standardized-Book-Publishing.json"
                                            background="transparent.html" speed="1" loop="" autoplay=""></lottie-player>
                                </div>
                                <div class="contentChoose">
                            ...
                            <div class="whychooeIconBoxInner">
                                <div class="letsconnect">
                                    <p>
                                        ...
                                        guarantee your happiness. Not only do we write stories, but we also bring them
                                        to life. <br>
                                        <b>Let’s connect!</b>
                                    </p>
                                </div>
